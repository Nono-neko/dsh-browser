 ...
 * backed by Node's resolver. The module's exports are the factory's return
 * value (the closure's own module.exports).
 *
 * Modeled on the dsh-web-ui family's shared vitest setup (Apache-2.0).
 */
